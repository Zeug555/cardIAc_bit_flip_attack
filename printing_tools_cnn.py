...
def main():
  ...
  folders = ['nominal_0.01', 'nominal_0.001', 'randbet_0.1_0.01_10_-1', 'clipping_0.1_0.01']
  colors = ['green', 'red', 'black', 'blue']
  labels = ['Nominal 0.01', 'Nominal 0.001', 'randbet + clipping 0.1', 'clipping 0.1 - lr 0.01']
